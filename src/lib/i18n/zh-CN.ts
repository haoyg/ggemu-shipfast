...
export const zhCnMessages = {
  ...
  homeContent: {
    whyTitle: '为什么在线玩复古游戏？',
    whyBody:
      'POKOPIE 让经典游戏可以更轻松地重新打开，不需要安装模拟器、下载文件或注册账号。进入游戏详情页后点击开始，就能直接在浏览器里加载游戏，桌面、平板和手机都可以访问。网站收录 NES、SNES、GBA、PS1、街机、Sega Genesis、N64 等多个平台的经典作品，你可以按平台浏览，也可以直接搜索游戏名。每个游戏都有独立详情页，包含封面、平台信息、玩法说明、相关游戏和分享入口，比单纯嵌入 iframe 更利于搜索引擎理解页面内容，也更方便玩家继续发现下一款游戏。',
    howTitle: '如何开始游戏',
    howSteps: [
      {
        title: '选择游戏',
        body: '通过搜索框输入游戏名，或按 NES、SNES、GBA、PS1、街机等平台浏览。',
      },
      {
        title: '进入详情页',
        body: '首页卡片会跳转到游戏专属页面，页面里有封面、介绍、相关游戏和开始按钮。',
      },
      {
        title: '浏览器直接开玩',
        body: '点击开始游戏后，使用键盘、触屏控件或支持的手柄进行操作。',
      },
    ],
  },
  detail: {
